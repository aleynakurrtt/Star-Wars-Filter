...
const characters = [
   ...
   let homeworldsRaw = [`tatooine` , `naboo`, `alderaan` , `stewjon`, `eriadu`, `kashyyyk`, `corellia`, `rodia`,`bestine`,`other` ]
  ...
  function renderCharacters() {
      ...
      if (cradeCard){
          cardArea.innerHTML = characters.map(function(character){
              return(`
             <div class="col-lg-4 col-md-6 card bg-dark px-4">
             <img class="img-1" src="${character.pic}">
             <h2 class="yazii">${character.name}</h2>
             <p class="yazii">${character.homeworld || "Unknown" } </p>
             </div>
              `)
          }).join("")
